...
gboolean        myfm_application_delete_in_progress     (MyFMApplication *self);
void            myfm_application_set_delete_in_progress (MyFMApplication *self, gboolean in_progress);
